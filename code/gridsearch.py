...
with open('./results/reward_gridsearch', 'w') as f:
    f.write('reg,n_fc3,n_fc4,reward_demo_avg_train,reward_demo_avg_test,reward_gen_avg,theta\n')

#with open('reward_gridsearch_10_22.csv', 'w') as f:
#    f.write('reg,n_fc3,n_fc4,reward_demo_avg_train,reward_demo_avg_test,reward_gen_avg,theta\n')


#list_reg = ['dropout', 'l1l2', 'dropout_l1l2']
list_reg = ['dropout_l1l2']
list_nfc3 = range(6,10,2)
list_nfc4 = range(6,10,2)
...
for reg in list_reg:
    ...
    for n_fc3 in list_nfc3:
        ...
        for n_fc4 in list_nfc4:
            ...
            ac = ac_irl.AC_IRL(theta=15.0, reg=reg, n_fc3=n_fc3, n_fc4=n_fc4)
